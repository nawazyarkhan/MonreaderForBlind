...
- **Best Verified Result:** **95.31% test accuracy** and **0.9530 macro F1** on the saved model `model_0` run
...
- **10-epoch training** for `model_0` and `model_1` with Adam and `CrossEntropyLoss`
